  ...
  <div class="wrapper">
    <div class="info-table">
      ...
      <div class="button-group">
        <button type="button" class="info-button btn-password" onclick="location.href='/instructor/updatePw'">비밀번호 변경</button>
        <button type="button" class="info-button btn-edit" onclick="location.href='/instructor/updateInfo'">개인정보 수정</button> 
      </div>
    </div>
  </div>
